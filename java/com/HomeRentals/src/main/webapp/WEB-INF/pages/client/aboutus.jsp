  ...
  <section class="about-section">
    ...
    <div class="about-content">
      <div class="about-text">
        <h3>Who We Are</h3>
        <p>
          Villare Rentals is a modern platform designed to simplify the process
          of finding and renting homes. We aim to provide users with a seamless
          and reliable experience when searching for rental properties.
        </p>

        <h3>Our Mission</h3>
        <p>
          Our mission is to connect tenants and property owners through a clean,
          easy-to-use platform. We focus on convenience, transparency, and
  ...
  <div class="slider-container">
    ...
    <div class="team-slider" id="teamSlider">
      <div class="team-card">
        ...
        <div class="socials">
          <a href="https://www.instagram.com/assassin_e96/"
            ><i class="fa-brands fa-instagram"></i
          ></a>
          <a href="https://www.linkedin.com/in/prasimbasnet096/"
            ><i class="fa-brands fa-linkedin"></i
          ></a>
          <a href="https://www.facebook.com/prasim.basnet/"
      ...
      <div class="team-card">
        ...
        <div class="socials">
          ...
          <a href="https://github.com/AarishDuwal"
            ><i class="fa-brands fa-github"></i
          ></a>
        </div>
      </div>
      <div class="team-card">
        ...
        <div class="socials">
          ...
          <a href="#"><i class="fa-brands fa-linkedin"></i></a>
          <a href="#"><i class="fa-brands fa-facebook"></i></a>
          <a href="https://github.com/replic005"
            ><i class="fa-brands fa-github"></i
          ></a>
        </div>
      </div>
      <div class="team-card">
        ...
        <div class="socials">
          ...
          <a href="#"><i class="fa-brands fa-linkedin"></i></a>
          <a href="#"><i class="fa-brands fa-facebook"></i></a>
          <a href="https://github.com/SwapnilKatuwal"
            ><i class="fa-brands fa-github"></i
          ></a>
        </div>
      </div>
      <div class="team-card">
        ...
        <div class="socials">
          ...
          <a href="#"><i class="fa-brands fa-linkedin"></i></a>
          <a href="#"><i class="fa-brands fa-facebook"></i></a>
          <a href="https://github.com/X33N1C"
            ><i class="fa-brands fa-github"></i
          ></a>
        </div>
      </div>
